...
print("Percentage of people with advanced education making more than 50K:", percentage_advanced_education)
...
print("Percentage of people without advanced education making more than 50K:", percentage_no_advanced_education)
...
print("Percentage of people who work the minimum hours per week and have salary >50K:", min_hours_50k)
...
print("Percentage of people earning >50K in that country:", percentage_highest_50k)
